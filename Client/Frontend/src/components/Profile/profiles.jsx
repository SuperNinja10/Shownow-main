...
import { Card, Avatar, Container, makeStyles, CardActions, CardActionArea, CardMedia, CardContent, Typography, Button, Grid, Tooltip, Fab } from "@material-ui/core";
...
import Cover, { AddButton } from './cover';
...
export default function Profiles() {
    ...
    const cover = (
        (name != null) ?
            (name._id == params.id) ? (<Cover open={open} setOpen={setOpen} scroll={scroll} setScroll={setScroll} />) : (<h1></h1>)
            :
            (<h1></h1>)
    )
            ...
            (
                ...
                <Box style={{
                    ...
                    <CardMedia
                        ...
                        height="500"
                        image={"https://raw.githubusercontent.com/SuperNinja10/SVG-hosting/26ee83b0fa0c63520221a7f3302c36eebd815548/place%20your%20movie%20here.svg"}
                    />
